            ...
            <div className="flex justify-between items-center">
                ...
                <ul className="flex items-center space-x-4">
                    ...
                    <li className="text-white font-semibold text-lg">
                        {isLoggedIn ? <button onClick={handleLogout} className="text-white font-semibold text-lg">Log out</button> : <Link className="text-white font-semibold text-lg" to='/auth/signin'>Login</Link>}
                    </li>
                </ul>
            </div>
        </Container>
